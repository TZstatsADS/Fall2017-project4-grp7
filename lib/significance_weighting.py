...
###############################data2
    ...
    sig_weights1,devalued_weights1=significance_weighting(train1)
    sig_weights2,devalued_weights2=significance_weighting(train2)

###########################significance weighting 
#<50 common rated items, significance weight = n/50
#>50 common rated items, significance weight = 1
def significance_weighting(data,correlation):
    data=data.values
