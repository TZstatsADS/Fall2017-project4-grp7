...
weights_neighbor1, neighbors1 = selecting_neighborhood(20, pearson_corr1, train1.values)
weights_neighbor2, neighbors2 = selecting_neighborhood(20, pearson_corr2, train2.values)
